...
#import "MultipleCellViewController.h"
#import "Utility.h"
#import "Cache.h"
#import "MultipleViewCell.h"

@interface MultipleCellViewController ()

@end

@implementation MultipleCellViewController
...
- (void)viewDidLoad
{
    ...
    self.tableView.estimatedRowHeight = 297;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    MultipleViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"multipleViewCell"];
    if (cell != nil)
    {
