...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object
{
    ...
    else
    {
        ...
        if (cell != nil)
        {
            ...
            [cell.mediaStoryTextLabel setDetectionBlock:^(STTweetHotWord hotWord, NSString *string, NSString *protocol, NSRange range) {
                NSArray *hotWords = @[@"Handle", @"Hashtag", @"Link"];
            ...
            CGSize constrainedSize = CGSizeMake(cell.mediaStoryTextLabel.frame.size.width  , 9999);
            ...
            if (requiredHeight.size.width > cell.mediaStoryTextLabel.frame.size.width) {
                requiredHeight = CGRectMake(0,0, cell.mediaStoryTextLabel.frame.size.width, requiredHeight.size.height);
            }
            CGRect newFrame = cell.mediaStoryTextLabel.frame;
            newFrame.size.height = requiredHeight.size.height;
            cell.mediaStoryTextLabel.frame = newFrame;
            

            [cell.mediaStoryTextLabel sizeToFit];
