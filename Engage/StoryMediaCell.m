...
@synthesize authorPic, storyMediaThumb, storyAuthorLabel, mediaStoryTextLabel, storyTitleLabel, timeStampSinceCreationLabel, backgroundView, playButton,  likeButton, commentButton, delegate, thisStory, homeGroupLabel;
...
-(void)setMediaStory:(PFObject*)story
{
    ...
    */
    ...
    mediaStoryTextLabel.text = [story objectForKey:@"story"];
