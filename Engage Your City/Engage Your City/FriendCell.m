...
- (void)setUser:(PFUser *)aUser {
    ...
    // Set name
    [friendNameLabel setText:[user objectForKey:@"UsersFullName"]];
    // Set group
    ...
    if ([user objectForKey:@"Posts"]) {
        // get the likes
        storyCount = [[user objectForKey:@"Posts"] intValue];
        NSString* postString = [NSString stringWithFormat:@"Shared %d stories", storyCount];
        [friendStoriesLabel setText:postString];
    }
