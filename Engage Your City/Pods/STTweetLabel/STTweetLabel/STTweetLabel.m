...
- (void)setupLabel {
    ...
    _attributesText = @{NSForegroundColorAttributeName: [UIColor darkGrayColor], NSFontAttributeName: [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:14.0]};
    _attributesHandle = @{NSForegroundColorAttributeName: [UIColor colorWithRed:0.42 green:0.62 blue:0.06 alpha:1], NSFontAttributeName: [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:14.0]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [UIColor colorWithRed:0.02 green:0.47 blue:0.66 alpha:1], NSFontAttributeName: [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:14.0]};
    _attributesLink = @{NSForegroundColorAttributeName: [UIColor colorWithRed:0.3 green:0.65 blue:0.84 alpha:1], NSFontAttributeName: [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:14.0]};
